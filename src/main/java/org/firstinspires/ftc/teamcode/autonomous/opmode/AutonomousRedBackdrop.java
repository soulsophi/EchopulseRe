...
//                                    )
//                            ),
//                            backdropExteriorToStack(mecanumDrive,color),
//                            commandToAction(
//                                    new SequentialCommand(
//                                            new WaitCommand(()->mecanumDrive.pose.position.x<0),
...
//                    new ParallelAction(
//                            stack2ToBackdropExterior(mecanumDrive,color),
//                            commandToAction(
//                                    new ParallelCommand(
//                                            new SequentialCommand(
//                                                    new WaitCommand(300),
...
//
//                    )
////                    mecanumDrive.actionBuilder(AutonomousRedBackdropPoses.getBackdropExterior(color, startPosition))
////                            .setTangent(AutonomousRedBackdropPoses.getParkTangent(color, park))
////                            .splineToLinearHeading(AutonomousRedBackdropPoses.getParkPose(color,park), AutonomousRedBackdropPoses.getParkTangent(color, park))
////                            .build()
//            ));
//        }
//        while (opModeInInit()) {
...
//        final Pose2d stackPose = AutonomousRedBackdropPoses.getStackPose(color, AutonomousUtils.StartPosition.Backdrop);
...
//        final Pose2d cotPose = AutonomousUtils.mirrorColor(new Pose2d(AutonomousUtils.TILE_WIDTH, -2* AutonomousUtils.TILE_WIDTH- AutonomousUtils.TILE_WIDTH_HALF+2, Math.toRadians(0)),color);
//        final Pose2d cot2Pose = AutonomousUtils.mirrorColor(new Pose2d(-AutonomousUtils.TILE_WIDTH, -2* AutonomousUtils.TILE_WIDTH- AutonomousUtils.TILE_WIDTH_HALF+2, Math.toRadians(0)),color);
//        final Pose2d stackPose = AutonomousRedBackdropPoses.getStack2Pose(color, AutonomousUtils.StartPosition.Backdrop);
//        return drive.actionBuilder(backdropPose)
//                .setTangent(Math.toRadians(180))
//                .setReversed(true)
