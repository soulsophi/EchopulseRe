...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -5317.651892740264; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2756.5237567500576; // x position of the perpendicular encoder (in tick units)
    }
